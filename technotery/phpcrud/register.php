...
// }
  ...
  if(isset($_POST["submit"])){
    ...
    else
    {
      ...
      $query="INSERT INTO employee(firstname,lastname,dateofbirth,emtype,email,pwd) 
      VALUES('$fname','$lname','$date','$emtype','$email','$enc_pass')";
    ...
    // echo 
    // "
    // <script>alert('datab succesfully inserted')</script>
    // ";
