(function ($) {
    ...
    function contingency(contqty, contprice, getthis) {
        ...
        $(".tax_row").each(function (index, value) {
            taxoutput += Number($(this).val());
            console.log(taxoutput, 'xxxxxxxxxxxxxxxx')
    ...
    function gst() {
        ...
        if ($.isEmptyObject(newGst)) {
            console.log("The Array is Empty.");
        } else {
            newGst = [];
            console.log("The Array is not Empty.");
        }
        newGst.push(textArry);
        console.log(newGst, 'newGstnewGst');

    }
    /////////////////////////////////////////

    function inputinvoicehour() {
        ...
        newEmpty.push(invoiceParticularsArry);
        console.log(newEmpty, 'invoiceParticularsArry');
    }
    ///////////////////////////////////////////////////////////////////////////////////
    function inputinvoiceflat() {
        var invoiceParticularsArry = [];
        ...
        emptyBilling = "FLATRATE";
        newEmpty.push(invoiceParticularsArry);
        console.log(newEmpty, 'invoiceParticularsArry');

    }
    //////////////////////////////////////////
    function inputinvoicecon() {
        var invoiceParticularsArry = [];
    ...
    function terinvoice() {
        ...
        // console.log(termsArry,'termsdddddddddddd')
        ...
        console.log(termsArry, 'termsdddddddddddd')
        if ($.isEmptyObject(newTerm)) {
            console.log("The Array is Empty.");
        } else {
            newTerm = [];
            console.log("The Array is not Empty.");
        }
        newTerm.push(termsArry);
        console.log(newTerm, 'invoiceParticularsArry');
    ...
    ///////////////////////////hourdescription  on blur///////////////////////////////
    $(document).on('blur', '.hourdesc', function () {
    ...
    ////////////////////////////flat description blur///////////////////
    $(document).on('blur', '.flatdesc', function () {
        inputinvoiceflat();
    })
    ////////////////////////flat counting end//////////////////////
    ////////////////////////////cont start//////////////////////////////
    ...
    $(document).on('blur', '.contqty', function () {
        ...
        // getthis.closest('td').siblings().find('.conttotal').val(totalcont);
        /////////////////////////cont qtyblur time array json//////
        inputinvoicecon();
        ////////////////////////////////////////////////////////////////
        gst();

    });
    //////////////////cont on contprice blure///////////////////////////////
    var contpricevalue
    var contqtyvalue
    var contdescription
    ...
    $(document).on('blur', '.contprice', function () {
        ...
        ////////////////////contprice blur time array json /////////////////
    ...
    /////////////////////////////condescriptionper//////////
    $(document).on('blur', '.contdesc', function () {
