...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form action="{{url('/customerregister')}}" method="post" enctype="multipart/form-data" class="register-form outer-top-xs" role="form">
		@csrf
        ...
        <div class="form-group">
		    ...
		    <input type="tel" name="mobile"class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Profile Image<span>*</span></label>
		    <input type="file" name="img" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
		<div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
		    ...
		    <input type="password" name="confirmpwd" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
	  	<button type="submit" value="send" class="btn-upper btn btn-primary checkout-page-button">Sign Up</button>
	</form>
