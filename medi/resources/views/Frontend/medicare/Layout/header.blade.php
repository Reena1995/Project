...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/bootstrap.min.css')}}">

<!-- Customizable CSS -->
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/main.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/blue.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/owl.carousel.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/owl.transitions.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/animate.min.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/rateit.css')}}">
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/bootstrap-select.min.css')}}">

<!-- Icons/Glyphs -->
<link rel="stylesheet" href="{{url('Frontend/medicare/assets/css/font-awesome.css')}}">
      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
		   @if(Session('cust_id'))
            <li class="myaccount"><a href="myaccount"><span>My Account</span></a></li>
			@else
				@endif
			@if(Session('cust_id'))
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="home"> <img src="{{url('Frontend/medicare/assets/images/logo.png')}}" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
            ...
            <ul class="dropdown-menu">
              <li>
                <div class="cart-item product-summary">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> <a href="detail"><img src="{{url('Frontend/medicare/assets/images/products/p4.jpg')}}" alt=""></a> </div>
                    </div>
                    <div class="col-xs-7">
                      <h3 class="name"><a href="index8a95?page-detail">Simple Product</a></h3>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown hidden-sm"> <a href="contact">Contact us</a> </li>
                <li class="dropdown"> <a href="contact">Jewellery</a> </li>
                <li class="dropdown"> <a href="contact">Shoes</a> </li>
                <li class="dropdown"> <a href="contact">Kids & Girls</a> </li>
