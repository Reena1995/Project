                        ...
                        <div class="blog-view">
                            <article class="blog blog-single-post">
                                ...
                                <div class="blog-image">
                                    <a href="#."><img alt="" src="{{url('Backend/Admin/assets/img/blog/blog-01.jpg')}}" class="img-fluid"></a>
                                </div>
                                ...
                                <div class="about-author">
                                    <div class="about-author-img">
                                        <div class="author-img-wrap">
                                            <img class="img-fluid rounded-circle" alt="" src="{{url('Backend/Admin/assets/img/user.jpg')}}">
                                        </div>
                                    </div>
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="" src="{{url('Backend/Admin/assets/img/user.jpg')}}">
                                            </div>
                        ...
                        <div class="widget post-widget">
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid" src="{{url('Backend/Admin/assets/img/blog/blog-thumb-01.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid" src="{{url('Backend/Admin/assets/img/blog/blog-thumb-02.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid" src="{{url('Backend/Admin/assets/img/blog/blog-thumb-03.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid" src="{{url('Backend/Admin/assets/img/blog/blog-thumb-04.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
