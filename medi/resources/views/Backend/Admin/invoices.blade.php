                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0">
                                ...
                                <tbody>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="editinvoice"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="invoiceview"><i class="fa fa-eye m-r-5"></i> View</a>
									...
									<tr>
                                        <td>3</td>
                                        <td><a href="invoiceview">#INV-0003</a></td>
