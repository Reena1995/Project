                  ...
                  <form method="post" enctype="multipart/form-data" role="form">
                    ...
                    <div class="form-group form-inline">
                      <label >FirstName</label>
                       <input type="text" name="First_name" class="form-control " style="margin-left:65px;" placeholder="First_name" >					  
                    </div>
					<div class="form-group form-inline">
                      <label >LastName</label>
                       <input type="text" name="Last_name" class="form-control " style="margin-left:65px;" placeholder="Last_name" >					  
                    </div>
