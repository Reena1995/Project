										...
										<form>
											...
											<div class="row">
												...
												<div class="form-group pull-left">
													...
													<input type="button" name="newreg" class="btn btn-primary" onclick="location.href='reviews'"  data-type="button" value="click for the give reviews">
													</div></div>
													</div></div>
											<!--/.row-->
										</form><!--/form-->
					...
					<div class="new-project-details">
						...
						<div class=" col-sm-2">
							...
							<div class="col-sm-8">
								<div class="single-new-project">
									<h3>
										<a href="clientinquiry " class="slide-btn">
								You	Want To	Client Inquiry
									</a>
									</h3>
								</div><!-- /.single-new-project-->	
							</div>
