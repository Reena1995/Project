              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form method="post" enctype="multipart/form-data" role="form">
					...
					<select  name="loc_id" class="form-control" style="margin-left:70px;">
					...
					<div class="form-group form-inline">
                      <label >About Shop</label>
                       <textarea name="about_shop" class="form-control " style="margin-left:50px;" placeholder="about shop" >	</textarea>				  
                    </div>
					...
					<div class="form-group form-inline">
                      <label >Owner Name</label>
                       <input type="text" name="Ownername" class="form-control " style="margin-left:50px;" placeholder="shop owner name" >					  
                    </div>
