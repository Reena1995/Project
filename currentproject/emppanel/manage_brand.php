                    ...
                    <tbody>
					  ...
					  foreach($brand_arr as $data)
					  {
						?>
							...
							<td><a href="delete?del_brand_id=<?php echo $data->brand_id?>" class="btn btn-danger">Delete</a></td>
							<td><a href="edit_brand?btn_brand_id=<?php echo $data->brand_id;?>" class="btn btn-primary">Edit</a></td>
                            </tr>	
                       <?php							
					  }
					  ?>
