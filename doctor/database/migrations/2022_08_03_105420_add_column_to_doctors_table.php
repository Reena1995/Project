...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('doctors', function (Blueprint $table) {
            ...
            $table->string('hosiptal_afternoon_to')->after('hospital_morning_from');
            $table->string('hosital_afternoon_from')->after('hosiptal_afternoon_to');
            $table->string('hospital_evening_to')->after('hosital_afternoon_from');
