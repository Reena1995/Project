						...
						<div class="card-body">
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<img src="{{asset('upload/doctors/' . $fetch->profile_img)}}" width="100%" height="150px" alt="User Image">
									</div>
									<div class="doc-info-cont">
										...
										<p class="doc-department"><img src="{{url('Frontend/assets/img/specialities/specialities-05.png')}}" class="img-fluid" alt="Speciality"><?php echo $fetch->specialist_id?></p>
										
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo $fetch->state?> <?php echo $fetch->city?><a href="javascript:void(0);"></a></p>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i><?php echo $fetch->state?> <?php echo $fetch->city?></li>
						...
						<div class="card-body pt-0">
							...
							<div class="tab-content pt-0">
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a class="name"><?php echo $fetch->education?></a>
												...
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a  class="name"><?php echo $fetch->experience?></a>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="clinic-content">
													<h4 class="clinic-name"><a><?php echo $fetch->hospital_name?></a></h4>
													<p class="doc-speciality"><?php echo $fetch->specialist_id?></p>
													
													<div class="clinic-details mb-0">
														<h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i> <?php echo $fetch->address?> <br><a href="javascript:void(0);">Get Directions</a></h5>
														<ul>
															<li>
											...
											<div class="col-md-4">
												<div class="">
												<i class="far fa-money-bill-alt"></i>Consulting Fees: <?php echo $fetch->consulting_fees?><br>
												<i class="far fa-money-bill-alt"></i>Followup Fees: <?php echo $fetch->followup_fees?>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="service-list">
												<h4>Services</h4>
												<?php
														foreach($service_id_arr as $data)
														{
													?>
												<ul class="clearfix">
													
													<li><?php echo $data->tittle?> </li>
