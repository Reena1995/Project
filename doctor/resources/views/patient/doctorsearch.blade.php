									...
									<div class="doctor-widget">
										<div class="doc-info-left">
											<div class="doctor-img">
												...
												<img src="{{asset('upload/doctors/' . $data->profile_img)}}" width="100%" height="150px" alt="User Image">
												</a>
											</div>
											<div class="doc-info-cont">
												...
												<h5 class="doc-department"><img src="{{url('Frontend/assets/img/specialities/specialities-05.png')}}" class="img-fluid" alt="Speciality"><?php echo $data->specialist_id?></h5>
												
												<div class="clinic-details">
													<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo $data->state?> <?php echo $data->city?></p>
										...
										<div class="doc-info-right">
											<div class="clini-infos">
												<ul>
													...
													<li><i class="fas fa-map-marker-alt"></i><?php echo $data->state?> <?php echo $data->city?></li>
													<li><i class="far fa-money-bill-alt"></i> $300 - $1000 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i> </li>
												</ul>
											</div>
											<div class="clinic-booking">
												<a class="view-pro-btn" href="{{url('doctorprofile/'.$data->id)}}">View Profile</a>
