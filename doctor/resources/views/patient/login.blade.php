					...
					<div class="row">
						<div class="col-md-8 offset-md-2">
							...
							@endif
										...
										<form action="{{url('/patientlogin')}}" method="post" enctype="multipart/formdata">
											@csrf
											...
											<button class="btn btn-primary btn-block btn-lg login-btn" send="value" type="submit">Login</button>
											<div class="login-or">
