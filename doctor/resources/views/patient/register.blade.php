							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<!-- Register Form -->
										<form action="{{url('/register')}}" method="post" enctype="multipart/formdata">
											...
											<div class="form-group form-focus">
												<input type="password" name="confirmpwd" class="form-control floating">
												<label class="focus-label">Confirm Password</label>
											</div>
											<div class="text-right">
												<a class="forgot-link" href="{{url('/login')}}">Already have an account?</a>
											</div>
											<button class="btn btn-primary btn-block btn-lg login-btn" type="submit" send="value">Signup</button>
											<div class="login-or">
