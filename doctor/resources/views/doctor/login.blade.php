					...
					<div class="row">
						<div class="col-md-8 offset-md-2">
							...
							@endif
										...
										<form action="{{url('/adddoctorlogin')}}" method="post" enctype="multipart/form-data">
											@csrf
											...
											<button class="btn btn-primary btn-block btn-lg login-btn" type="submit" send="value">Login</button>
											<div class="login-or">
											...
											<div class="text-center dont-have">Don’t have an account? <a href="{{url('/doctor-contact')}}">contact us</a></div>
										</form>
									</div>
								</div>
							</div>
