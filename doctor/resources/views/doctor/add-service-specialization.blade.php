								...
								<div class="card-body">
									...
									<!-- Social Form -->
										 ...
										 @if(session()->has('success1'))
											...
											<h4 class="card-title">Add Services</h4>
												...
												<div class="form-group">
													<label>Service </label>
													<input type="text" class="form-control" name="tittle" placeholder="Tooth cleaning">
												</div>
										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<div class="col-md-6 col-lg-6">
											@if(session()->has('succes2'))
												<br>
												<i class="alert-success">{{session('succes2')}}</i>
												<br>
												@endif
											...
											<form action="{{url('/adddrspecialist')}}" method="post" enctype="multipart/form-data">
												@csrf
												<div class="form-group">
													<label>Specialization</label>
													<input type="text" class="form-control" name="tittle" placeholder="Oral and Maxillofacial Surgery">
												</div>
												<div class="submit-section">
										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<?php
												...
												<tr>
													...
													<td><?php echo $data1->doctor_id?></td>
													<td><?php echo $data1->tittle?></td>
													<td class="text-right">
														<div class="actions">
															<a  href="{{url('adddrspecialist/'.$data1->id)}}" class="btn btn-sm bg-danger-light">
																<i class="fe fe-trash"></i> Delete
															</a>
														</div>
													</td>
