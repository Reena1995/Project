					...
					<div class="row">
						...
						@csrf
									...
									<div class="row form-row">
							            <div class="col-md-12">
											...
											<!--<input type="file" class="form-control" value="{{asset('upload/doctor/'.$fetch->profile_img)}}" name="profile_img" alt="User Image">-->
													<img src="{{asset('upload/doctors/'.$fetch->profile_img)}}" height="50px" width="50px"> 
													...
													<div class="upload-img">
														<div class="change-photo-btn">
															...
															<input type="file" class="upload" name="profile_img" value="{{asset('upload/doctors/'.$fetch->profile_img)}}">
														</div>
							...
							<div class="submit-section submit-btn-bottom">
								<button type="submit" class="btn btn-primary submit-btn" name="update" value="send">Save Changes</button>
							</div>
						</form>	
						</div>
					</div>
