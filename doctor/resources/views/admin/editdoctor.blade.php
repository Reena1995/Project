								...
								<div class="card-body">
									...
									<form action="{{url('/edit/'.$fetch->id )}}" method="post" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea name="about" rows="4" cols="5" class="form-control" placeholder="Enter message" ><?php echo $fetch->about?></textarea>
													</div>
												</div>
											</div>
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control" name="profile_img" value="{{asset('upload/doctors/'.$fetch->profile_img)}}">
                                                        <img src="{{asset('upload/doctors/'.$fetch->profile_img)}}" height="70px" width="70px">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea  class="form-control" name="notification"><?php echo $fetch->notification?></textarea>
													</div>
												</div>
												<div class="form-group row">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea name="address" rows="4" class="form-control"><?php echo $fetch->address?></textarea>
													</div>
												</div>
										...
										<div class="text-right">
											<button type="submit" class="btn btn-primary" name="update" value="send">Update</button>
										</div>
									</form>
								</div>
							</div>
