						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">edit Healthmanager</h4>
									
							@endif
								</div>
								<div class="card-body">
									<form action="{{url('/editmanager/'.$fetch->id )}}" method="post" enctype="multipart/form-data">
									@csrf	
									<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control"  value="{{asset('upload/healthmanager/'.$fetch->profile_img)}}" name="profile_img">
														<img src="{{asset('upload/healthmanager/'.$fetch->profile_img)}}"height="50px" width="50px">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" value="<?php echo $fetch->first_name?>" name="first_name">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<?php foreach($company_id_arr as $data)
							                              {
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" value="<?php echo $fetch->Manager_name?>" name="Manager_name">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control"  value="{{asset('upload/visitingcard/'.$fetch->visiting_card)}}"  name="visiting_card">
										...
										<div class="text-right">
											<button type="submit" name="update" value="send" class="btn btn-primary">Submit</button>
										</div>
									</form>
								</div>
							</div>
