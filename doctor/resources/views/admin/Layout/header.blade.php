						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="{{url('/admin-specialities')}}"><i class="fe fe-user"></i>Manage Specialist</a></li>
									<li><a href="{{url('/admin-add-specialities')}}"><i class="fe fe-user-plus"></i>Add Specialist</a></li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li class="submenu">
								<a href="javascript:void(0);"><i class="fe fe-calendar"></i> Appointment<span></span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
								<li>
										<a href="{{url('/admin-patient-appointment')}}"> <span>Completed</span></a>
									</li>
									
									<li>
										<a href="{{url('/admin-patient-cancel-appointment')}}"> <span>Cancle</span></a>
									</li>
								</ul>
							</li>
									</ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span>Location</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-location')}}"><i class="fe fe-user"></i>Manage Location</a></li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
								<li>
										<a href="{{url('/admin-doctor-appointment')}}"> <span>Completed</span></a>
									</li>
									
									<li>
										<a href="{{url('/admin-doctor-cancel-appointment')}}"> <span>Cancle</span></a>
									</li>
								</ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
								<li>
										<a href="{{url('/admin-company-appointment')}}"> <span>Completed</span></a>
									</li>
									...
									<li><a href="{{url('/admin-company-appointment')}}"><i class="fe fe-calendar"></i>Appointment</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span>Health Manager</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-manager')}}"><i class="fe fe-user"></i>Manage </a></li>
								...
								<li>
									...
									<li><a href="{{url('/admin-manager-appointment')}}"><i class="fe fe-calendar"></i>Appointments</a></li>
								</ul>
							</li>
							<li class="submenu">
								...
								<li>
									...
									<li><a href="{{url('/admin-mr-appointment')}}"><i class="fe fe-calendar"></i>Appointments</a></li>
								</ul>
							</li>
							<li> 
