										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
													<select name="specialist_id" class="form-control" value="{{old('specialist_id')}}">
                                                        <option value="">Select Specialist</option>
														<?php foreach($special_id_arr as $data)
							                              {
								                        ?>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="liacence_no" value="{{old('liacence_no')}}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="tel" class="form-control" name="dr_mobile" value="{{old('dr_mobile')}}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea name="about" rows="4" cols="5" class="form-control" placeholder="Enter message" value="{{old('about')}}"></textarea>
														@if($errors->has('about'))	
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="short_tittle"  value="{{old('short_tittle')}}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control" name="profile_img"  value="{{old('profile_img')}}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control" name="visit_card"  value="{{old('visit_card')}}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="tel" class="form-control" name="office_no"  value="{{old('office_no')}}">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea  class="form-control" name="notification" value="{{old('notification')}}"></textarea>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="followup_fees" value="{{old('followup_fees')}}">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control" name="hospital_img[]" value="{{old('hospital_img')}}" multiple>
