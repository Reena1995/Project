						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Edit Specialities</h4>
								</div>
								<div class="card-body">
									<form action="{{url('/editspecialist/'.$fetch->id )}}" method="post" enctype="multipart/form-data">
									@csrf	
									<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
                                                        <input type="file" class="form-control"  value="{{asset('upload/specilities/'.$fetch->img)}}" name="img">
                                                        <img src="{{asset('upload/specilities/'.$fetch->img)}}"height="50px" width="50px">
