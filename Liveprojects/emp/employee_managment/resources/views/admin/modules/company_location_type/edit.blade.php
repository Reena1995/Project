                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30">
                                <div class="card-header">
                                    <div class="card-title">Edit  Company Location Type Details</div>
                                </div>
                                <div class="card-body">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="personal-details-tab-z" data-toggle="tab" href="#personal-details" role="tab" aria-controls="personal-details" aria-selected="true"> Company Location Type Details</a>
                                        </li>
                                       
                                       
                                    </ul>
                                    <form name="form" action="{{route('company_location_type.update',$location_type->uuid)}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                            ...
                                            <div class="tab-pane fade show active" id="personal-details" role="tabpanel" aria-labelledby="personal-details-tab">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                        <label>Company Location Type Name</label>
                                                        <input type="text" id="type" name="type" value="{{$location_type->type}}" class="form-control form-control-lg"  />
                                                        @if ($errors->has('type'))
    ...
    <script>
         $(document).ready(function(){
            $("form[name='form']").validate({
                ...
                messages : {
                    type : "Please enter a location type name",
