                            ...
                            <div class="card-body " >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="text" value = "{{ $family->contact_no}}" name="contact_no[]" class="form-control form-control-lg" placeholder="Enter University Name">
                    ...
                    <div class="card education mt-3 familyadd educationDetails" id="">
                        ...
                        <div class="card-body " >
                            ...
                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div>
                                    <button type="submit" id="familyBtn" class="btn btn-danger d-none delete">delete</button> 
                                </div>
