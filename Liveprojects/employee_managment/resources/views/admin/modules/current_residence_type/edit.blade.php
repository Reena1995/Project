                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="current_residence_type_name" name="current_residence_type_name" value="{{$resitype->type}}"  class="form-control form-control-lg" placeholder="current Residence Type name" />
