                            ...
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="personal-details-tab-z" data-toggle="tab" href="#personal-details" role="tab" aria-controls="personal-details" aria-selected="true">  Education Level  Details</a>
                                        </li>
                                       
                                       
                                    </ul>
                                    <form name="form" action="{{route('education_level.update',$edulevel->uuid)}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                        <div class="tab-content" id="myTabContent1">
                                            <div class="tab-pane fade show active" id="personal-details" role="tabpanel" aria-labelledby="personal-details-tab">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" id="name" name="name" value="{{$edulevel->name}}" class="form-control form-control-lg"  />
                                                        @if ($errors->has('name'))
                                            ...
                                            <div class="card-footer p-t-20 text-right">
                                                <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                    <a href="{{route('education_level.index')}}" class="theme-btn-outline text-white">
                                                        cancel
                                                    </a>
                                                </div>
                                                <div class="btn-group mr-2" role="group" aria-label="Second group">
    ...
    <script>
         $(document).ready(function(){
            $("form[name='form']").validate({
                ...
                messages : {
                    name : "Please enter a  Education Level name",
