        ...
        <section class="admin-content">
            ...
            <div class="container-fluid p-t-20">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 m-b-20 text-right pl-3 small-button">
                        <button type="button" class="btn text-white add-new-emp" data-toggle="modal"
                            data-target="#holidaymodal">Add Holidays</button>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 m-b-30">
                        ...
                        <div class="card m-b-0">
                            <div class="card-header">
                                <div class="card-title">Holidays Lists</div>
                            </div>
