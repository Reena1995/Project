                        ...
                        <div class="card education mt-3 eduremove educationDetails" id="">
                            <div class="card-body " >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>percentage</label>
                                                <input type="text"  value=""  class="form-control form-control-lg" name="{{ 'percentage[]' }}" value = ""   placeholder="Enter percentage">
                                                @error('percentage')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                        </div>
                                        ...
                                        <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>passingyear</label>
                                                <input type="text"  value=""  class="form-control form-control-lg" name="{{ 'passingyear[]' }}" value = ""   placeholder="Enter passingyear">
                                                @error('passingyear')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                        </div>
