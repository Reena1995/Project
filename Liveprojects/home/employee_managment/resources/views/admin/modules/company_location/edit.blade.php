                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30">
                                <div class="card-header">
                                    <div class="card-title">Edit  Company Location Details</div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form name="form" action="{{route('company_location.update',$location->uuid)}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                            ...
                                            <div class="tab-pane fade show active" id="personal-details" role="tabpanel" aria-labelledby="personal-details-tab">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <input type="text" id="name" name="name" value="{{$location->name}}" class="form-control form-control-lg"  />
                                                        @if ($errors->has('name'))
