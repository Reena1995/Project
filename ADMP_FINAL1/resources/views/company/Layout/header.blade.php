						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('company-doctor');?>">
											<a href="{{url('/company-doctor')}}"><i class="fe fe-user"></i> <span>View Doctors</span></a>
									</li>
									<li class="<?php active('company-fav-doctor');?>">
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('company-mr');?>">
											<a href="{{url('/company-mr')}}"><i class="fe fe-user"></i> <span>Manage MR</span></a>
									</li>
									<li class="<?php active('company-mr-appointmen');?>">
