...
<head>
		...
		<title>Adocmedi - @yield('title')</title>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item">
						<a href="#" class="nav-link">
							<p style="font-size:20px"><i class="fe fe-user"></i>  Hi.. {{Session('cname')}} </p>
						</a>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('admin-add-specialities');?>"><a href="{{url('/admin-add-specialities')}}"><i class="fe fe-user"></i> Add Specialities </a></li>
									<li class="<?php active('admin-specialities');?>"><a href="{{url('/admin-specialities')}}"><i class="fe fe-user"></i> Manage Specialities </a></li>
								</ul>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('admin-patient');?>">
											<a href="{{url('/admin-patient')}}"><i class="fe fe-user"></i> <span>Manage Patients</span></a>
									</li>
									<li class="<?php active('admin-patient-appointment');?>">
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('admin-manager');?>">
											<a href="{{url('/admin-manager')}}"><i class="fe fe-user"></i> <span>Manage Manager</span></a>
									</li>
									
									<li class="<?php active('admin-manager-appointment');?>">
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('admin-mr');?>">
											<a href="{{url('/admin-mr')}}"><i class="fe fe-user"></i> <span>Manage MR</span></a>
									</li>
									
									<li class="<?php active('admin-mr-appointment');?>">
							...
							<li class="<?php active('admin-stockiest');?>"> 
