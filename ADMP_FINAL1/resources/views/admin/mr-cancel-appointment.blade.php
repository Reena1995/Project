...
@section('title','Admin Manage MR Cancel Appointments Request')
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">MR Cancel Appointments Request</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a></li>
									<li class="breadcrumb-item active">MR Cancel Appointments Request</li>
								</ul>
							</div>
						</div>
					</div>
