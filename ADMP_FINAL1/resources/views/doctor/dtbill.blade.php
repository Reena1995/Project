...
@section('title','Doctor View Patient Prescription')
						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Patient Prescription</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Patient Prescription</h2>
						</div>
					</div>
				</div>
			</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="invoice-info">
												<strong class="customer-text">Report From</strong>
										...
										<div class="col-md-6">
											<div class="invoice-info invoice-info2">
												<strong class="customer-text">Report To</strong>
												<p class="invoice-details">
