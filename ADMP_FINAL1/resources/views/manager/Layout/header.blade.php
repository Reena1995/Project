				...
				<ul class="nav user-menu">
					...
					<li class="nav-item">
						<a href="#" class="nav-link">
							<p style="font-size:20px"><i class="fe fe-user"></i>  Hi.. {{Session('mname')}} </p>
						</a>
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li class="<?php active('manager-doctor')?>">
											<a href="{{url('/manager-doctor')}}"><i class="fe fe-user"></i> <span>View Doctors</span></a>
									</li>
									<li class="<?php active('manager-fav-doctor')?>">
