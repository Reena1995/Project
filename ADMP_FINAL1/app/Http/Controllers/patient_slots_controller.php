...
class patient_slots_controller extends Controller
{
    ...
    public function destroyslot($day)
    {
        $data=patient_slots::where('day','=',$day)
        ->where('doc_id','=',session('doctor_id'))->delete();
        Alert::success('Done', 'You\'ve Successfully Delete Slots');
        return back();
    ...
    public function showpatient(Request $request, $id)
    {
        ...
        {        
			...
			$app_data=appointments::join('patient_slots','appointments.slot_id','=','patient_slots.id')->where('appointments.date','=',$searchbydate)
			->where('patient_slots.doc_id','=',$doc_id)->get(['appointments.slot_id']);
			$arrdata=$app_data->toArray();
			
			$Morningsearchdate=patient_slots::where('day','=',$day)->where('time','=','Morning')->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
            $afternoonsearchdate=patient_slots::where('day','=',$day)->where('time','=','afternoon')->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
			$eveningsearchdate=patient_slots::where('day','=',$day)->where('time','=','evening')->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
        }
        ...
        {        
            ...
            $Morningsearchdate=patient_slots::where('day','=',$day)->where('time','=','Morning')->where('slot_timing','>',$cur_time)->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
            $afternoonsearchdate = patient_slots::where('day', '=', $day)->where('time', '=', 'afternoon')->where('slot_timing','>',$cur_time)->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
            $eveningsearchdate=patient_slots::where('day','=',$day)->where('time','=','evening')->where('slot_timing','>',$cur_time)->where('doc_id','=',$doc_id)->whereNotIn('id',$arrdata)->get();
        }
        else
        {
            $current=date('d-m-Y');
			...
			$app_data=appointments::join('patient_slots','appointments.slot_id','=','patient_slots.id')->where('appointments.date','=',$cur_date	)
			->where('patient_slots.doc_id','=',$doc_id)->get(['appointments.slot_id']);
			$arrdata=$app_data->toArray();
