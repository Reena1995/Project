...
Route::group(['middleware'=>['doctorafterlogin']], function()
{
	...
	Route::get('/doctor-stockiest-find',[stockiest_controller::class,'allstockiest']);
	Route::post('/doctor-stockiest-find',[stockiest_controller::class,'allstockiest']);

	Route::get('/doctor-pharma-find',[mr_controller::class,'allpharmaperson']);
	Route::post('/doctor-pharma-find',[mr_controller::class,'allpharmaperson']);
	/*
...
Route::group(['middleware'=>['afterlogin']], function()
{
	...
	Route::get('/adminstockiestdelete/{id}',[stockiest_controller::class,'adminstockiestdelete']);
	Route::get('/adminstockieststatus/{id}',[stockiest_controller::class,'adminstockieststatus']); 
