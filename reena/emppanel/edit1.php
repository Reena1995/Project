                ...
                <div class="box-body" align="center">
                  <form method="post" enctype="multipart/form-data" role="form">
					...
					<div class="form-group form-inline">
                      <img src="../upload/employee/" style="width:18%; border-radius:50%" align="center" alt="">	  
                    </div>
					...
					<div class="form-group">
                      ...
                      <input type="button" name="edit" style="margin-left:1000px;" value="Edit Profile" onclick="location.href='editprofile?btn_Employee_id=<?php echo $fetch->Employee_id;?>'" class="btn btn-primary">
                    </div>
