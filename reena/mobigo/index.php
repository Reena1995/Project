								...
								<div class="row">
									<div class="col-sm-12">
										<div class="single-slide-item-content">
											<h2>Consult Your <br> Mobile service  With Us</h2>
											<p>
												We are the unique Consultancy platform for your Mobile Related solution, That is ready to take challenge and knockout your mobiles problems. 
											</p>
							...
							<div class="container">
								<div class="row">
									<div class="col-sm-12">
										<div class="single-slide-item-content">
											<h2>
												Consult Your <br> Mobile service  With Us
											</h2>
											<p>
									We are the unique Consultancy platform for your Mobile Related solution, That is ready to take challenge and knockout your mobiles problems.  
											</p>
						...
						<div class="col-sm-6">
							<div class="single-about-us">
								<div class="about-us-img">
									<img src="assets/images/about/b1.jpg" alt="about images">
								</div><!--/.about-us-img-->
							</div><!--/.single-about-us-->
						</div><!--/.col-->
					</div><!--/.row-->
		...
		<section id="project"  class="project">
			<div class="container">
						...
						<div class="gallery-content">
							<div class="isotope">
								<div class="row">
									<div class=" col-md-4 col-sm-12">
										<div class="item big-height">
											<img src="assets/images/project/store2.jpg" alt="portfolio image"/>
									...
									<div class="col-md-8 col-sm-12">
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<div class="item">
													<img src="assets/images/project/store5.jpg" alt="portfolio image"/>
													<div class="isotope-overlay">
														<a href="project.php">
															<span class="lnr lnr-link"></span>
											...
											<div class="col-sm-6 col-xs-12">
												<div class="item">
													<img src="assets/images/project/store3.jpg" alt="portfolio image"/>
													<div class="isotope-overlay">
														<a href="project.php">
															<span class="lnr lnr-link"></span>
										...
										<!--<div class="row">
											<div class="col-sm-4 col-xs-12">
												<div class="item">
													<img src="assets/images/project/store7.jpg" alt="portfolio image"/>
													<div class="isotope-overlay">
														<a href="project.php">
															<span class="lnr lnr-link"></span>
											...
											<div class="col-sm-4 col-xs-12">
												<div class="item">
													<img src="assets/images/project/store9.jpg" alt="portfolio image"/>
													<div class="isotope-overlay">
														<a href="project.php">
															<span class="lnr lnr-link"></span>
											...
											<div class="col-sm-4 col-xs-12">
												<div class="item">
													<img src="assets/images/project/store11.jpg" alt="portfolio image"/>
													<div class="isotope-overlay">
														<a href="project.php">
															<span class="lnr lnr-link"></span>
								...
								<div class="row">
									<div class=" col-md-4 col-sm-12">
										<div class="item big-height">
											<img src="assets/images/project/store10.jpg" alt="portfolio image"/>
											<div class="isotope-overlay">
												<a href="project.php">
													<span class="lnr lnr-link"></span>
				...
				<div class="project-btn text-center">
					<a href="store.php"  class="project-view">view all
					</a>
				</div><!--/.project-btn-->
			</div><!--/.container-->
							...
							<div class="col-md-3 col-sm-6">
								<div class="pricing-box">
									...
									<div class="project-btn pricing-btn text-center">
										<a href="project.php"  class="project-view">
											Sign Up Now
										</a>
									</div><!--/.project-btn-->
								</div><!--/.pricing-box-->
			...
			<div class="container">
				<div class="news-details">
					...
					<div class="news-card news-card-pb-25">
							...
							<div class="project-btn text-center">
								<a href="blog.php"  class="project-view">read more
								</a>
							</div><!--/.project-btn-->
					</div><!--/.news-card-->
